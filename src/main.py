...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if current_mode == MODE_INITIAL_LANE_FOLLOW:
            ...
            is_green_detected, _ = traffic_detector.get_traffic_light_status(current_image)
            ...
            leba_angle, leba_speed, lebacon_section_complete = sonic_driver.get_drive_values(current_image)
            ...
            angle, speed, lane_change_done = lane_changer.get_control(current_image)
